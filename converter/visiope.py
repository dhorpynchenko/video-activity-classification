...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 0 ###TODO your assignment
...
class CocoDataset(utils.Dataset):
    ...
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        self.path = "C:/Users/Edo/Desktop/working directory"  ##TODO: add the path to the dataset folder
        self.jsonName = "icehockey.json"  ##TODO: add json file name
        ...
        for i in range(1, len(classes)):
            self.add_class("visiope", i, classes[i])

        # Add images
        for i in image_ids:
            self.add_image(
                "visiope", image_id=i,
                path=dataset_dir + "/pngImages/image" + str(i))
        if return_coco:
            return b
    ...
    def load_mask(self, image_id):
        ...
        """
        self.path = "C:/Users/Edo/Desktop/jsonProva"  ##TODO: add the path to the dataset folder
        self.jsonName = "icehockey.json"  ##TODO: add json file name
        self.nomeBase = "image"
        ret1 = []
        ret2 = []
